...
<div style="border: 20px outset rgb(181, 147, 125); position: absolute; top: 50px; left: 200px; width: 440px; height: 440px; background-color: black;">
<?php
echo '
...
<div style="position: absolute; top: 50px; left: 200px;"><img style="width: 440px; height: 440px;" src="',$d,'/imgt.jpg">
</div>
...
<div id="17" style="position: absolute; visibility: hidden; top: 0px; left: 700px;">h2 class="u-custom-font u-text u-text-custom-color-3 u-text-2" data-animation-name="customAnimationIn" data-animation-duration="1000" data-animation-direction="">BRAVO!</h2>
</div>';
?>
